...
set dialog_text to "Enter the number of minutes before shutdown"
display dialog dialog_text default answer 10 giving up after 60
set shutdown_delay_minutes to text returned of result as number
